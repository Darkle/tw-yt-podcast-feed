...
var _rssParser = __webpack_require__(/*! rss-parser */ "./node_modules/rss-parser/index.js");

var _rssParser2 = _interopRequireDefault(_rssParser);

var _rss = __webpack_require__(/*! rss */ "./node_modules/rss/lib/index.js");
...
var defaultYTdLparams = ['--restrict-filenames', '-f bestaudio'];
...
function getNewTWvideos() {
  return feedParser.parseURL(ytChannelFeed).then(function (_ref) {
    var videos = _ref.items;

    var twVideos = videos.filter(function (video) {
    ...
    return pexecFile(youtubedlBinaryPath, [twVideos[0].link].concat(_toConsumableArray(defaultYTdLparams === void 0 ? [] : defaultYTdLparams))).then(function (result) {
      return console.log(result);
    }).then(function () {
      return twVideos;
    });
  }).then(function (twVideos) {
    var feed = new _rss2.default({
      title: 'ThreatWire',
      image_url: 'https://www.hak5.org/wp-content/uploads/2016/04/logo_black_small.png'
    });
    twVideos.forEach(function (video) {
      return feed.item({
        title: video.title,
        guid: video.id,
        url: video.link,
    ...
    return pwriteFile(feedFilePath, feed);
  }).catch(function (e) {
...
var xml = __webpack_require__(/*! xml */ "./node_modules/xml/lib/xml.js");
...
var escapeForXML = __webpack_require__(/*! ./escapeForXML */ "./node_modules/xml/lib/escapeForXML.js");
